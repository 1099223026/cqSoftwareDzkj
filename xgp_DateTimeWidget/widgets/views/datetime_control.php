...
<?php echo $this->context->form->field($this->context->model, $this->context->attribute,[
        'template' => "{label}\n<div class=\"col-sm-7\"><div class=\"input-append date form_datetime\">{input}<span style=\"height: 35px;width: 28px;margin-left: 0px;\" class=\"add-on\"><i class=\"icon-th\" style=\"margin-top: 5px;\"></i></span></div></div>\n<div class=\"col-sm-3\" >{error}</div>"]
    )
                ->textInput(['value' => date("Y-m-d H:i:s", $this->context->value), 'maxlength' => true,'readonly' => 'readonly','style'=>'border-radius:0;width: 160px;'])
